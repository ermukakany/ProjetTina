...
public class AccountGeneral {
     ...
     * Account type id
     */
    public static final String ACCOUNT_TYPE = "cloudm120152016.puy2docs";

    /**
     * Account name
     */
    public static final String ACCOUNT_NAME = "Puy2Docs";
    ...
    public static final ServerQueries serverQueries = new ServerQueries();
